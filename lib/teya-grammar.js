...
rules.expr = function( parser, params ) {
    ...
    */
    ...
    if ( parser.is_token( ':' ) ) {
        ...
        //  FIXME: Неправильно. inline_ternary может быть частью другого inline_expr.
...
//  FIXME: А не нужен ли тут унарный плюс?
//  А почему не может быть больше одного минуса (плюса)?
//  И может нужно назвать как-то по-другому? inline_sign?
//
