...
asts.def_template.w_action = function() {
...
asts.def_var.w_action = function() {
...
asts.if._get_type = function() {
    ...
    for (var i = 0, l = elses.length; i < l; i++) {
        type = types.common_type( type, elses[ i ] );
    }
