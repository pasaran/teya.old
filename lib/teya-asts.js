...
asts.inline_string.w_prepare = function() {
    this.cast( TYPE.STRING );
};
...
asts.string_expr.oncast = function( to ) {
    this.expr.cast( to );
};
...
asts.string_literal.stringify = function() {
    var value = ( this.to_type ) ? R[ this.from_type + '_to_' + this.to_type ]( this.value ) : this.value;
